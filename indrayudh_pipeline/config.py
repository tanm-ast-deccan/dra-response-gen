...
class GenParams:
    ...
    # ── Agentic loop ──────────────────────────────────────────────────
    max_turns: int = 6            # max tool-calling rounds per task
    ...
    # ── Local tool calling ────────────────────────────────────────────
    enabled_tools: list[str] = field(default_factory=list)  # names in tools.TOOL_REGISTRY
    ...
    code_exec_timeout: int = 120  # seconds for the local subprocess

    # ── Reliability ───────────────────────────────────────────────────
    request_timeout: int = 600    # per-request timeout (seconds)
